...
if __name__ == '__main__':
    ...
    #     probs = VE(medical, v, [t, hl])
    #     probs1 = VE(medical, v, [hl])
    #     print(probs1)
    #     print(probs)
    #     doms = v.domain()
    #     #for i in range(len(probs)):
    ...
    # evidence = []
    # evidence_name = "" 
    # print("P({})".format(v.name))
    # probs = VE(medical, v, evidence)
    # print(probs)
    # #bmi, co, ht, hl, vg, gd, rg, db, ag, ac
    # for t in [ht, ag, ac, vg]:
    #     evidence.append(t)
    #     evidence_name += t.name + ", " 
    #     print("P({}|{})".format(v.name, evidence_name)) 
    #     probs = VE(medical, v, evidence)
    #     print(probs)
    V0 = bmi
    V1 = ht
    ...
    V1.set_evidence('YES')
    prob_1 = VE(medical, V0, [V1])
    print(prob_1)

    V2.set_evidence('~60')
    prob_2 = VE(medical, V0, [V1, V2])
    print(prob_2)

    V3.set_evidence('Insufficient')
    prob_3 = VE(medical, V0, [V1, V2, V3])
    print(prob_3)

    V4.set_evidence('Countryside')
    prob_4 = VE(medical, V0, [V1, V2, V3, V4])
    print(prob_4) 

    # V5.set_evidence('YES')
    # prob_5 = VE(medical, V0, [V1, V2, V3, V4, V5])
    # print(prob_5)
